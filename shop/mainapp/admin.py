...
class NotebookAdminForm(ModelForm):
    ...
    def clean_image(self):
        ...
        # print(img.width, img.height, img)
        min_height, min_width = Product.MIN_RESOLUTION
        max_height, max_width = Product.MAX_RESOLUTION
        if image.size > Product.MAX_IMAGE_SIZE:
            raise ValidationError('Размер изображения не больше 3Мб')
...
class SmartphoneAdmin(admin.ModelAdmin):
    ...
    # подмена джангового шаблона по-умолчанию
    # содержание файла из документации - https://docs.djangoproject.com/en/3.0/ref/contrib/admin/javascript/
