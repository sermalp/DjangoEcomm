    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ManyToManyField(blank=True, related_name='related_card', to='mainapp.CardProduct')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='cardproduct',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.product', verbose_name='Корзина'),
        ),
        migrations.AddField(
            model_name='cardproduct',
            name='user',
